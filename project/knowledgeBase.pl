...
examTime('4','12:20 PM','01:20 PM','MT104','C-301').
examTime('4','12:20 PM','01:20 PM','MT104','C-302').
examTime('4','12:20 PM','01:20 PM','MT104','C-303').
examTime('4','12:20 PM','01:20 PM','MT104','C-304').
examTime('4','12:20 PM','01:20 PM','MT104','C-305').
examTime('4','12:20 PM','01:20 PM','MT104','C-307').
examTime('4','12:20 PM','01:20 PM','MT104','C-308').
examTime('4','12:20 PM','01:20 PM','MT104','C-309').
examTime('4','12:20 PM','01:20 PM','MT104','C-310').
examTime('4','12:20 PM','01:20 PM','MT104','C-311').
examTime('4','12:20 PM','01:20 PM','MT104','C-401').
examTime('4','12:20 PM','01:20 PM','MT104','C-402').
examTime('4','12:20 PM','01:20 PM','MT104','C-403').
examTime('4','12:20 PM','01:20 PM','MT104','C-404').
examTime('4','12:20 PM','01:20 PM','MT104','C-405').
examTime('4','12:20 PM','01:20 PM','MT104','C-408').
examTime('4','12:20 PM','01:20 PM','MT104','C-409').
...
examTime('5','12:20 PM','01:20 PM','EL229','C-301').
examTime('5','12:20 PM','01:20 PM','EL229','C-302').
examTime('5','12:20 PM','01:20 PM','EL229','C-303').
examTime('5','12:20 PM','01:20 PM','EL229','C-304').
examTime('5','12:20 PM','01:20 PM','EL229','C-305').
examTime('5','12:20 PM','01:20 PM','EL229','C-307').
examTime('5','12:20 PM','01:20 PM','EL229','C-308').
examTime('5','12:20 PM','01:20 PM','EL229','C-309').
...
query1(STUDENTNAME):-
    (
        (student(R1,STUDENTNAME),
        section(R1,SECTION),
        coursesection(COURSECODE1,SECTION),
        coursesection(COURSECODE2,SECTION),
        COURSECODE1\==COURSECODE2,
        examTime(DATE1,_,_,COURSECODE1,_),
        examTime(DATE2,_,_,COURSECODE2,_),
        DATE1==DATE2)
        -> write('yes')
        ; write('no')
    ).

isTeaching(INSTRUCTOR_NAME,COURSE_NAME):-
    instructor(EMAIL,INSTRUCTOR_NAME),
    course(COURSE_CODE,COURSE_NAME),
    coursesection(COURSE_CODE,SECTION1),
    teaches(EMAIL,SECTION2),
    SECTION1==SECTION2.


query3(COURSENAME1, COURSENAME2):-
    course(COURSECODE1,COURSENAME1),
    course(COURSECODE2,COURSENAME2),
    examTime(DATE1,S1,E1,COURSECODE1,_),
    examTime(DATE2,S2,E2,COURSECODE2,_),
    DATE1==DATE2,S1==S2,
    E1==E2.

roomCollison(COURSENAME_1, COURSENAME_2):-
    course(COURSECODE_1,COURSENAME_1),
    course(COURSECODE_2,COURSENAME_2),
    examTime(DATE1,S1,E1,COURSECODE_1,RID1),
    examTime(DATE2,S2,E2,COURSECODE_2,RID2),
    (DATE1==DATE2,S1==S2,E1==E2,RID1==RID2).

query5(RID1, RID2, DATE,TIME):-
    capacity(RID1,C1),
    capacity(RID2,C2),
    C1==C2,
	examTime(DATE,TIME,E1,COURSECODE1,RID1),
	examTime(DATE,TIME,E1,COURSECODE1,RID2).

checkRoom(RID, DATE,STARTTIME):-
    examTime(DATE,STARTTIME,_,_,RID).

query7(STUDENTNAME1,STUDENTNAME2,COURSENAME):-
    course(COURSECODE,COURSENAME),
    coursesection(COURSECODE,SECTION),
    student(R1,STUDENTNAME1),
    student(R2,STUDENTNAME2),
    section(R1,SECTION1),
    section(R2,SECTION2),
    SECTION1==SECTION2,SECTION==SECTION1.

belongtoDuplicateRollNum(STUDENTNAME):-
    student(R1,STUDENTNAME),
    student(R2,STUDENTNAME),
    R1\==R2.


query9(INSTRUCTORNAME):-
	instructor(EMAIL,INSTRUCTORNAME),
    teaches(EMAIL,SECTION1),
	teaches(EMAIL,SECTION2),
	coursesection(COURSECODE,SECTION1),
	coursesection(COURSECODE,SECTION2),
	SECTION1\==SECTION2.


teachesTwoCourses(NAME):-
instructor(EM,NAME),
teaches(EM,S1),
teaches(EM,S2),
coursesection(C1,S1),
